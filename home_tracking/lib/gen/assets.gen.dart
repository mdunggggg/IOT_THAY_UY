...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/air_on.svg
  SvgGenImage get airOn => const SvgGenImage('assets/icons/air_on.svg');

  /// File path: assets/icons/ari_off.svg
  SvgGenImage get ariOff => const SvgGenImage('assets/icons/ari_off.svg');
  ...
  List<dynamic> get values =>
      [airOn, ariOff, fan, lightOff, lightOn, sun, temp, water];
}
...
class Assets {
  ...
  static const LottieGenImage empty = LottieGenImage('assets/empty.json');
  static const $AssetsIconsGen icons = $AssetsIconsGen();
  static const $AssetsImagesGen images = $AssetsImagesGen();

  /// List of all assets
  static List<LottieGenImage> get values => [empty];
}
