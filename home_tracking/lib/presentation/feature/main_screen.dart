        ...
        return Scaffold(
          ...
          bottomNavigationBar: SalomonBottomBar(
            ...
            items:  [
              ...
              SalomonBottomBarItem(icon: const Icon(Icons.art_track_sharp), title: const Text("Action"), selectedColor: Colors.red),
              SalomonBottomBarItem(icon: const Icon(Icons.data_thresholding_outlined), title: const Text("Data"), selectedColor: Colors.green),
